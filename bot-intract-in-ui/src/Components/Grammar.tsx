...
const Grammar: React.FC = () => {
  ...
  // New state variables for dropdown functionality
  const [isGrammarTableOpen, setIsGrammarTableOpen] = useState(true);
...
const toggleGrammarTable = () => {
  setIsGrammarTableOpen(!isGrammarTableOpen);
};

const toggleSwot = () => {
  setIsSwotOpen(!isSwotOpen);
};
          ...
          <div className="grammar_content">
            <div className="result-stats-container">
                <div className="result-stat-box">
                  ...
                  <div className="stat-value">{grammarCorrectionResult.total.toFixed(2)}%</div>
                </div>
                <div className="result-stat-box">
                  <div className="stat-label">Final Sentiment</div>
                  <div className="stat-value">{sentimentResult?.final_csi !== undefined ? sentimentResult.final_csi.toFixed(2) : "N/A"}</div>
                </div>
              </div>
            ...
            {/* Grammar Table Dropdown */}
            <div className="dropdown-container">
              <button 
                className="dropdown-button"
                onClick={toggleGrammarTable}
              >
                Grammar Analysis {isGrammarTableOpen ? '▲' : '▼'}
              </button>
